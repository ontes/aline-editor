...
extern fn GetKeyboardState(key_state: *[256]u8) Bool;
pub const getKeyboardState = GetKeyboardState;
extern fn ToAscii(virt_key: c_uint, scan_code: c_uint, key_state: *const [256]u8, char: *u16, flags: c_uint) c_int;
pub const toAscii = ToAscii;
extern fn ToUnicode(virt_key: c_uint, scan_code: c_uint, key_state: *const [256]u8, buff: [*]u16, buff_len: c_int, flags: c_uint) c_int;
pub const toUnicode = ToUnicode;
